...
public class DrawableArrow {
    ...
    public DrawableArrow(int x1, int y1, int x2, int y2, int src, int dest, double edgeWeight) {
        this.x1 = x1;
        this.y1 = y1;
        this.x2 = x2;
        this.y2 = y2;
    ...
    public void initialize() {
        ...
        barb = 25;
        color = new Color(64,  64,  64); // dark gray
    ...
    public void paint(Graphics g) {
        ...
        if(edgeWeight > -1) {
            text = edgeWeight + "";
            Color colorBlue = new Color(204,238,241); // blue
